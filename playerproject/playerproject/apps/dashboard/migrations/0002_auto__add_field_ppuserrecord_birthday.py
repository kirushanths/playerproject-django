...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PPUserRecord.birthday'
        db.add_column(u'dashboard_ppuserrecord', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PPUserRecord.birthday'
        db.delete_column(u'dashboard_ppuserrecord', 'birthday')
