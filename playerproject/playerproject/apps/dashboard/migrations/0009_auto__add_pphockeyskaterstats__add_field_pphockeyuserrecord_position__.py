...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PPHockeyUserRecord.position'
        db.add_column(u'dashboard_pphockeyuserrecord', 'position',
                      self.gf('django.db.models.fields.CharField')(default='not_specified', max_length=30),
                      keep_default=False)

        # Deleting field 'PPHockeyPlayerStats.plus_minus'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'plus_minus')

        # Deleting field 'PPHockeyPlayerStats.goals'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'goals')

        # Deleting field 'PPHockeyPlayerStats.assists'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'assists')

        # Deleting field 'PPHockeyPlayerStats.position'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'position')

        # Deleting field 'PPHockeyPlayerStats.shoots'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'shoots')

        # Deleting field 'PPHockeyPlayerStats.points'
        db.delete_column(u'dashboard_pphockeyplayerstats', 'points')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PPHockeyUserRecord.position'
        db.delete_column(u'dashboard_pphockeyuserrecord', 'position')
        ...
        # Adding field 'PPHockeyPlayerStats.goals'
        db.add_column(u'dashboard_pphockeyplayerstats', 'goals',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PPHockeyPlayerStats.assists'
        db.add_column(u'dashboard_pphockeyplayerstats', 'assists',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PPHockeyPlayerStats.position'
        db.add_column(u'dashboard_pphockeyplayerstats', 'position',
                      self.gf('django.db.models.fields.CharField')(default='not_specified', max_length=30),
                      keep_default=False)
        ...
        # Adding field 'PPHockeyPlayerStats.points'
        db.add_column(u'dashboard_pphockeyplayerstats', 'points',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
