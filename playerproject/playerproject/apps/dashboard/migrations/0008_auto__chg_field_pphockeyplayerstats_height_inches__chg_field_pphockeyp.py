...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PPHockeyPlayerStats.height_inches'
        db.alter_column(u'dashboard_pphockeyplayerstats', 'height_inches', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'PPHockeyPlayerStats.height_feet'
        db.alter_column(u'dashboard_pphockeyplayerstats', 'height_feet', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PPHockeyPlayerStats.height_inches'
        db.alter_column(u'dashboard_pphockeyplayerstats', 'height_inches', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PPHockeyPlayerStats.height_feet'
        db.alter_column(u'dashboard_pphockeyplayerstats', 'height_feet', self.gf('django.db.models.fields.IntegerField')(null=True))
