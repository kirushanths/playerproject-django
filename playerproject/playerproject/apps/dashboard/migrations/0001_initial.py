...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PPUserRecord'
        db.create_table(u'dashboard_ppuserrecord', (
            ...
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dashboard_ppuserrecord_related', null=True, to=orm['accounts.PPUser'])),
        ...
        db.send_create_signal('dashboard', ['PPUserRecord'])
        ...
        db.create_table(u'dashboard_ppplayerstats', (
            ...
            ('time_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('time_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dashboard_ppplayerstats_related', null=True, to=orm['accounts.PPUser'])),
        ))
        ...
        db.create_table(u'dashboard_pphockeyplayerstats', (
            (u'ppplayerstats_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['dashboard.PPPlayerStats'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'PPUserRecord'
        db.delete_table(u'dashboard_ppuserrecord')
