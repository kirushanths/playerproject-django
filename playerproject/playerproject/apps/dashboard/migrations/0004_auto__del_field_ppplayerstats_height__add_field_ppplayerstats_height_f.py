...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PPPlayerStats.height_feet'
        db.add_column(u'dashboard_ppplayerstats', 'height_feet',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPPlayerStats.height_inches'
        db.add_column(u'dashboard_ppplayerstats', 'height_inches',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PPPlayerStats.height_feet'
        db.delete_column(u'dashboard_ppplayerstats', 'height_feet')

        # Deleting field 'PPPlayerStats.height_inches'
        db.delete_column(u'dashboard_ppplayerstats', 'height_inches')
