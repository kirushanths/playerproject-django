...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DZTemplate.created_by'
        db.add_column(u'dashboard_dztemplate', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['accounts.DZUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DZTemplate.created_by'
        db.delete_column(u'dashboard_dztemplate', 'created_by_id')
