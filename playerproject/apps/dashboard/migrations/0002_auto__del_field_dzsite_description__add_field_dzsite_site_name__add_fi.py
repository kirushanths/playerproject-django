...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DZSite.description'
        db.delete_column(u'dashboard_dzsite', 'description')

        # Adding field 'DZSite.site_name'
        db.add_column(u'dashboard_dzsite', 'site_name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DZTemplate.template_name'
        db.add_column(u'dashboard_dztemplate', 'template_name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'DZTemplate.is_confirmed'
        db.add_column(u'dashboard_dztemplate', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DZTemplate.is_verified'
        db.add_column(u'dashboard_dztemplate', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DZTemplate.is_upload'
        db.add_column(u'dashboard_dztemplate', 'is_upload',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DZSite.description'
        db.add_column(u'dashboard_dzsite', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Deleting field 'DZSite.site_name'
        db.delete_column(u'dashboard_dzsite', 'site_name')

        # Deleting field 'DZTemplate.template_name'
        db.delete_column(u'dashboard_dztemplate', 'template_name')

        # Deleting field 'DZTemplate.is_confirmed'
        db.delete_column(u'dashboard_dztemplate', 'is_confirmed')

        # Deleting field 'DZTemplate.is_verified'
        db.delete_column(u'dashboard_dztemplate', 'is_verified')

        # Deleting field 'DZTemplate.is_upload'
        db.delete_column(u'dashboard_dztemplate', 'is_upload')
    ...
    models = {
        'accounts.dzuser': {
            ...
            'role': ('django.db.models.fields.CharField', [], {'default': "'user'", 'max_length': '60', 'null': 'True', 'blank': 'True'}),
        ...
        'dashboard.dzsite': {
            ...
            'site_name': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
        ...
        'dashboard.dztemplate': {
            ...
            'is_upload': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'template_name': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'time_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'time_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'})
        },
